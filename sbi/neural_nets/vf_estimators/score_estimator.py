...
class ScoreEstimator(VectorFieldEstimator):
    """Score estimator for score-based generative models (e.g., denoising diffusion)."""
    ...
    def __init__(
        ...
        """
        Class for score estimators with variance exploding (NCSN), variance
        preserving (DDPM), or sub-variance preserving SDEs.
        """
        ...
        # Set mean and standard deviation functions based on the type of SDE and noise
        # bounds.

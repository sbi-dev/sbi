...
from zuko.flows import GMM as zuko_GMM
from zuko.flows.core import Flow

from sbi.types import Shape

# import GMM from zuko.flows.GMM as zuko_GMM


class ZukoFlow_GMM(zuko_GMM):
    ...
    def __init__(
        # self, logits, means, precisions, sumlogdiag, precision_factors
        self,
        net: Flow,

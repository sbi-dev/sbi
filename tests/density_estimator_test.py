...
from sbi.neural_nets.density_estimators.shape_handling import reshape_to_batch_iid_event
...
@pytest.mark.parametrize(
    "theta_or_x_shape, target_shape, event_shape, batch_is_iid",
    (
        ((3,), (1, 1, 3), (3,), False),
        ((3,), (1, 1, 3), (3,), True),
        ((1, 3), (1, 1, 3), (3,), False),
        ...
        ((2, 3, 5), (2, 1, 3, 5), (3, 5), False),
        ((2, 3, 5), (1, 2, 3, 5), (3, 5), True),
...
def test_shape_handling_utility_for_density_estimator(
    ...
    output = reshape_to_batch_iid_event(
        input, event_shape=event_shape, batch_is_iid=batch_is_iid
    )

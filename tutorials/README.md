...
2. _contributers_ who develop methods and/or plan to contribute to `sbi` toolbox
...
## I want to start using `sbi` (_user_)
Before going through the tutorial jupyter notebooks, make sure to read through the **Overview, Motivation and Approach** below.
...
- [Inferring parameters for a single observation ](03_multiround_inference.ipynb) introduces the concept of multi round inference.

 To see a scientific use cases, we recommend going through [the example for a scientific simulator from neuroscience](../examples/00_HH_simulator.ipynb) to see a scientific use case.

- [All implemented methods](16_implemented_methods.ipynb)

## I want to contribute to `sbi` (_contributer_)
- [Getting started](00_getting_started_flexible.ipynb) introduces the `sbi` package and its core functionality.
...
- different sampling algs




All should look at diagnostics


I want to apply SBI to my data




I want to contribute to SBI development
